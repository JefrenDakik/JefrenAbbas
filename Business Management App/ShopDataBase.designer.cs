...
namespace Business_Management_App
{
    ...
    partial void DeleteVendor_Arrival_Day(Vendor_Arrival_Day instance);
		...
		public ShopDataBaseDataContext() : 
				base(global::Business_Management_App.Properties.Settings.Default.ShopDataBaseConnectionString1, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnAddressChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Phone_Number", DbType="NChar(8)")]
	...
	public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<float> _Total_Unit_Price;
    ...
    partial void OnTotal_Unit_PriceChanging(System.Nullable<float> value);
    partial void OnTotal_Unit_PriceChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Total_Unit_Price", AutoSync=AutoSync.Always, DbType="Real", IsDbGenerated=true, UpdateCheck=UpdateCheck.Never)]
		public System.Nullable<float> Total_Unit_Price
		{
			get
			{
				return this._Total_Unit_Price;
			}
			set
			{
				if ((this._Total_Unit_Price != value))
				{
					this.OnTotal_Unit_PriceChanging(value);
					this.SendPropertyChanging();
					this._Total_Unit_Price = value;
					this.SendPropertyChanged("Total_Unit_Price");
					this.OnTotal_Unit_PriceChanged();
				}
			}
		}
